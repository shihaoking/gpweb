...
.log{line-height:27px;height:30px; font-size:12px;text-align:left;padding-left:10px; }
...
<div class="u_info">
<?php if($_username) { ?>
<strong><?php echo get_nickname();?></strong>欢迎您<strong style="margin-left:10px"><?php echo $_groupname;?></strong>用户<?php echo $_groupid;?>
<!--
...
<?php if($_groupid == 6) { ?>
<a class="logined_lk" href="<?php echo $CATEGORYS['6']['url'];?>">查看<strong>[<?php echo $CATEGORYS['6']['catname'];?>]</strong></a>
<?php } ?>
