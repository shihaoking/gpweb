...
<script type="text/javascript">
    ...
    <div class="col-auto">
        ...
        <div class="box cat-area">
             ...
             <div class="content">
                <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=efc745099178fb4ffa7e8aa2e471e22b&action=lists&catid=7&num=20&order=inputtime+DESC\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'lists')) {$data = $content_tag->lists(array('catid'=>'7','order'=>'inputtime DESC','limit'=>'20',));}?>
