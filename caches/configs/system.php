...
'cookie_pre' => 'zvpSO_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
...
'upload_url' => 'http://www.jdw2006.com/uploadfile/', //附件路径
'attachment_stat' => '0',//是否记录附件使用状态 0 统计 1 统计， 注意: 本功能会加重服务器负担

'js_path' => 'http://www.jdw2006.com/statics/js/', //CDN JS
'css_path' => 'http://www.jdw2006.com/statics/css/', //CDN CSS
'img_path' => 'http://www.jdw2006.com/statics/images/', //CDN img
'app_path' => 'http://jinshihao482.gotoip3.com/',//动态域名配置地址
...
'gzip' => 1, //是否Gzip压缩后输出
'auth_key' => 'NLyGImaeN4wZ5ix6fEvz', //密钥
'lang' => 'zh-cn',  //网站语言包
'lock_ex' => '1',  //写入缓存时是否建立文件互斥锁定（如果使用nfs建议关闭）

'admin_founders' => '2', //网站创始人ID，多个ID逗号分隔
'execution_sql' => 0, //EXECUTION_SQL

'phpsso' => '0',	//是否使用phpsso
'phpsso_appid' => '1',	//应用id	
'phpsso_api_url' => 'http://www.jdw2006.com/phpsso_server',	//接口地址
'phpsso_auth_key' => 'KxF9SZGf0vnI2L8C9sFpByXfg7cUdaNb', //加密密钥
