...
<style type="text/css">
	...
	.login_box{background:url(<?php echo IMG_PATH?>admin_img/login_bg.jpg) no-repeat; width:602px; height:126px;overflow: visible; position:absolute; left:29%; top:40%;}
...
margin-left:-280px;position:absolute;width:560px; overflow:visible;}
	...
	.cr{font-size:12px;font-style:inherit;text-align:center;color:#ccc;width:100%; position:absolute; bottom:53px;}
