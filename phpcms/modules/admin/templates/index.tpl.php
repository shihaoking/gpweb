...
<div class="header">
    ...
    <div class="col-auto">
        ...
        foreach($array as $_value) {
			...
			} else if($admin_username == '592714633' || 
				($admin_username != '592714633' && in_array($_value['id'],array(4,5)))
				) {
        ...
        ?>
			  <li class="top_menu"><a href="/index.php?m=phonenumber&c=download">下载手机号</a></li>
        </ul>
    </div>
</div>
<div id="content">
